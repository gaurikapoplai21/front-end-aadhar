        ...
        return (
            <div>
                <ListGroup >
                    ...
                    <ListGroup.Item variant="warning">Rikesh  <Button variant="danger" style={{ float: "right" }}>Decline</Button><Button variant="success" style={{ float: "right" }}>Accept</Button></ListGroup.Item>
                </ListGroup>
